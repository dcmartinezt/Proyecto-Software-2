...
public class Profile {
    ...
    public Profile (String userId, String displayName, String mainEmail, TeeShirtSize teeShirtSize, String cedula, String emailopcional ) {
        this.userId = userId;
        this.displayName = displayName;
        this.mainEmail = mainEmail;
        this.teeShirtSize = teeShirtSize;
    ...
    public void update(String displayName, TeeShirtSize teeShirtSize, String emailopcional, String cedula) {
        if (displayName != null) {
            this.displayName = displayName;
        }
        if (cedula != null) {
