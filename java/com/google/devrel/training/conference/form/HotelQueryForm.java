...
import com.google.devrel.training.conference.form.HotelQueryForm.Field;
import com.google.devrel.training.conference.form.HotelQueryForm.FieldType;
import com.google.devrel.training.conference.form.HotelQueryForm.Filter;
import com.google.devrel.training.conference.form.HotelQueryForm.Operator;
import com.googlecode.objectify.cmd.Query;
public class HotelQueryForm {
	private static final Logger LOG = Logger.getLogger(HotelQueryForm.class.getName());
     ...
     */
    public HotelQueryForm filter(Filter filter) {
        if (filter.operator.isInequalityFilter()) {
