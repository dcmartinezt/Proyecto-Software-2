...
public class ConferenceApi {
    ...
    public Profile saveProfile(final User user, ProfileForm profileForm)
        ...
        String emailopcional= profileForm.getTeEmailopcional();// linea de caro
        String cedula= profileForm.getCedula();//linea de Caro
        ...
        if (profile == null) {
            ...
            if (cedula == null) { // linea caro
                cedula = "NO ESTÁ ESPECIFICADO";//linea caro
            }
            if (emailopcional == null) {
                cedula = "NO ESTA ESPECIFICADO"; //linea caro
            }
            // Now create a new Profile entity
            profile = new Profile(userId, displayName, mainEmail, teeShirtSize,emailopcional, cedula);// agregamos cedula y emailopcional
        } else {
            // The Profile entity already exists
            // Update the Profile entity
            profile.update(displayName, teeShirtSize,emailopcional, cedula);
        }
